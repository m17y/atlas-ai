...
1. http://localhost:3000/categories 所有的分类都显示不出来，请帮我修复，你可以查找AI相关工具仔细补充分类数据
2. http://localhost:3000/admin/login 我输入了账号密码，但是登录失败，还是返回登录页面
---
...
1. ✅ **恢复版本** - 恢复到 2025-02-01 版本，保留原有后台管理页面
